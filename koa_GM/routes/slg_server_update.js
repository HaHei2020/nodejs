 ...
 * 服务器热更 路由
 */
const slg_server_update = require('koa-router')();
const Manager = require('../models/manager');

slg_server_update.prefix('/slg_server_update');

slg_server_update.get('/index', checkNotLogin);
slg_server_update.get('/index', async (ctx, next) => {
    await ctx.render('./slg_server_update/index', {
        title: '服务器热更',
...
module.exports = slg_server_update;
